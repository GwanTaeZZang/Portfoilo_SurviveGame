...
public class CharacterSelectCanvas : UIBaseController
{
    ...
    private List<CharacterElement> characterElementList;
    private List<Job> jobList;
    private List<Sprite> characterSpriteList;

    private void Start()
    {
        characterElementList = new List<CharacterElement>();
    ...
    private void SetCharacterElement()
    {
        ...
        {
            int idx = i;
            CharacterElement element = Instantiate(characterElementPrefab, characterElementParent);
